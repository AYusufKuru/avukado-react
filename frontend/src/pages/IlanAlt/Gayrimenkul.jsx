...
import {
    ...
    Users,       // Taraflar
    Building,    // Bina, Kat Mülkiyeti
    // Gayrimenkul Hukuku için eklenen/kullanılan ikonlar
    Home,        // Gayrimenkul, Tapu
    KeyRound,    // Kira, Tahliye
    Files,       // Tapu Kayıtları
    Hammer       // İnşaat, İmar
} from "lucide-react";
...
export default function Gayrimenkul() {
    ...
    // Gayrimenkul kategorisindeki ilanları API'den çek
        ...
        <div className="min-h-screen bg-white text-neutral-900">
                ...
                <div className="mx-auto max-w-7xl px-4 py-12 lg:py-14 grid gap-8 lg:grid-cols-[1.1fr_1fr] items-start">
                    ...
                    <div>
                        <h1 className="text-3xl md:text-4xl font-extrabold leading-tight" style={{ color: NAVY }}>
                            Gayrimenkul Hukuku: Tapu, <br className="hidden md:block" />
                            Kira ve İmar Çözümleri
                        </h1>

                        <p className="mt-4 text-neutral-700 max-w-2xl">
                            Mülkiyet ilişkilerinizin her aşamasında gizlilik ve şeffaflıkla size eşlik ediyoruz. Tapu işlemleri,
                            Medeni Kanun (MK), Kat Mülkiyeti Kanunu (KMK) kapsamındaki haklarınızı ve durumunuza göre
                            oluşabilecek maliyetleri burada özetliyoruz.
                        </p>

                        {/* Kısa bilgi butonları (Gayrimenkul'e uyarlandı) */}
                        <div className="mt-5 flex flex-wrap gap-3">
                            <Pill icon={<Gavel className="w-4 h-4" />} label="Dava Süreci" />
                            <Pill icon={<Coins className="w-4 h-4" />} label="Maliyetler" />
                            <Pill icon={<Home className="w-4 h-4" />} label="Tapu İşlemleri" />
                            <Pill icon={<KeyRound className="w-4 h-4" />} label="Kira/Tahliye" />
                        </div>

                        {/* CTA’lar (Gayrimenkul'e uyarlandı) */}
                    ...
                    {/* Sağ kutu (Gayrimenkul'e uyarlandı) */}
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                <h3 className="font-semibold" style={{ color: NAVY }}>
                                    Gayrimenkul Süreci Nasıl İşler?
                                </h3>
                                <p className="text-sm text-neutral-600 mt-1">
                                    Tapu incelemesi, ihtarname, dava açılışı, keşif/bilirkişi ve karar/temyiz aşamaları.
                                </p>

                                <ul className="mt-3 space-y-2 text-sm">
                                    <li className="flex items-start gap-2">
                                        <span className="mt-1.5 h-2 w-2 rounded-full bg-amber-500" />
                                        Tapu ve imar durumu analizi
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="mt-1.5 h-2 w-2 rounded-full bg-amber-500" />
                                        Sözleşme (kira, satış vaadi) hazırlama
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="mt-1.5 h-2 w-2 rounded-full bg-amber-500" />
                                        Dava ve tapu tescil işlemleri
                                    </li>
                                </ul>
                                ...
                                <div className="mt-4 grid sm:grid-cols-2 gap-3">
                                    ...
                                    <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
                                        ...
                                        <p className="text-xs text-neutral-600 mt-1">Tapu, kira sözleşmesi ve imar belgelerini güvenle paylaşın.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section id="turler" className="mx-auto max-w-7xl px-4 pb-4">
                <h2 className="text-xl md:text-2xl font-bold text-center" style={{ color: NAVY }}>
                    Başlıca Gayrimenkul Hizmetleri
                </h2>
                <p className="mt-2 text-center text-neutral-600">
                    Mülk sahipleri, kiracılar ve yatırımcılar için hukuki destek ve danışmanlık.
                </p>
                ...
                <div className="mt-6 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
                    <TypeCard
                        ...
                        title="Tapu Davaları"
                        text="Tapu iptal tescil, yolsuz tescil, muvazaa ve el atmanın önlenmesi (müdahale) davaları."
                    />
                    <TypeCard
                        icon={<KeyRound className="w-6 h-6" />}
                        title="Kira Hukuku"
                        text="Kiracı tahliye, kira tespit davaları, kira sözleşmesi hazırlama ve uyarlama davaları."
                    />
                    <TypeCard
                        icon={<Building className="w-6 h-6" />}
                        title="İzale-i Şuyu ve Kat Mülkiyeti"
                        text="Ortaklığın giderilmesi davaları, site yönetimi uyuşmazlıkları ve aidat takipleri."
                    />
                    <TypeCard
                        icon={<Hammer className="w-6 h-6" />}
                        title="İmar ve İnşaat Hukuku"
                        text="İmar planı itirazları, kentsel dönüşüm süreçleri ve inşaat sözleşmeleri (arsa payı)."
                    />
                </div>
            </section>
            ...
            {/* ----------------- GAYRİMENKUL HUKUKU İLANLARI ----------------- */}
            <section className="bg-neutral-50 py-12">
                <div className="mx-auto max-w-7xl px-4">
                    <div className="mb-8 text-center">
                        <h2 className="text-2xl md:text-3xl font-bold" style={{ color: NAVY }}>
                            Gayrimenkul Hukuku İlanları
                        </h2>
                        <p className="mt-2 text-neutral-600">
                            Müvekkillerin oluşturduğu gayrimenkul hukuku ilanlarını keşfedin ve teklif verin.
                        </p>
                    </div>
                    ...
                    {isLoadingAds ? (
                        ...
                        <div className="text-center py-12">
                            <p className="text-neutral-600">Henüz gayrimenkul hukuku kategorisinde açık ilan bulunmamaktadır.</p>
                        </div>
                    ) : (
