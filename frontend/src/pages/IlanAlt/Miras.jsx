...
export default function Miras() {
    ...
    // Miras kategorisindeki ilanları API'den çek
    ...
    return (
        <div className="min-h-screen bg-white text-neutral-900">
            ...
            {/* ----------------- MİRAS HUKUKU İLANLARI ----------------- */}
            <section className="bg-neutral-50 py-12">
                <div className="mx-auto max-w-7xl px-4">
                    <div className="mb-8 text-center">
                        <h2 className="text-2xl md:text-3xl font-bold" style={{ color: NAVY }}>
                            Miras Hukuku İlanları
                        </h2>
                        <p className="mt-2 text-neutral-600">
                            Müvekkillerin oluşturduğu miras hukuku ilanlarını keşfedin ve teklif verin.
                        </p>
                    </div>
                    ...
                    {isLoadingAds ? (
                        ...
                        <div className="text-center py-12">
                            <p className="text-neutral-600">Henüz miras hukuku kategorisinde açık ilan bulunmamaktadır.</p>
                        </div>
                    ) : (
