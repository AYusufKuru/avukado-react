...
export default function Tuketici() {
    ...
    // Tüketici kategorisindeki ilanları API'den çek
    ...
    return (
        <div className="min-h-screen bg-white text-neutral-900">
            ...
            {/* ----------------- TÜKETİCİ HUKUKU İLANLARI ----------------- */}
            <section className="bg-neutral-50 py-12">
                <div className="mx-auto max-w-7xl px-4">
                    <div className="mb-8 text-center">
                        <h2 className="text-2xl md:text-3xl font-bold" style={{ color: NAVY }}>
                            Tüketici Hukuku İlanları
                        </h2>
                        <p className="mt-2 text-neutral-600">
                            Müvekkillerin oluşturduğu tüketici hukuku ilanlarını keşfedin ve teklif verin.
                        </p>
                    </div>
                    ...
                    {isLoadingAds ? (
                        ...
                        <div className="text-center py-12">
                            <p className="text-neutral-600">Henüz tüketici hukuku kategorisinde açık ilan bulunmamaktadır.</p>
                        </div>
                    ) : (
