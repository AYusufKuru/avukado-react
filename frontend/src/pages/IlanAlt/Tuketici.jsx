...
import {
    ...
    Users,       // Taraflar
    // Tüketici Hukuku için eklenen/kullanılan ikonlar
    ShoppingCart, // Tüketim, E-Ticaret
    ShieldAlert,  // Ayıplı Mal, İhtar
    Receipt,      // Fatura, Masraf
    RefreshCcw    // İade, Değişim
} from "lucide-react";
...
export default function Tuketici() {
        ...
        <div className="min-h-screen bg-white text-neutral-900">
                ...
                <div className="mx-auto max-w-7xl px-4 py-12 lg:py-14 grid gap-8 lg:grid-cols-[1.1fr_1fr] items-start">
                    ...
                    <div>
                        <h1 className="text-3xl md:text-4xl font-extrabold leading-tight" style={{ color: NAVY }}>
                            Tüketici Hukuku: İade, <br className="hidden md:block" />
                            Değişim ve Haklarınız
                        </h1>

                        <p className="mt-4 text-neutral-700 max-w-2xl">
                            Satın alımlarınızın her aşamasında gizlilik ve şeffaflıkla size eşlik ediyoruz.
                            TKHK (Tüketicinin Korunması Hakkında Kanun), Tüketici Hakem Heyeti (THH) süreçleri ve
                            durumunuza göre oluşabilecek maliyetleri burada özetliyoruz.
                        </p>

                        {/* Kısa bilgi butonları (Tüketici'ye uyarlandı) */}
                        <div className="mt-5 flex flex-wrap gap-3">
                            <Pill icon={<Gavel className="w-4 h-4" />} label="Süreç" />
                            <Pill icon={<Scale className="w-4 h-4" />} label="THH Başvuru" />
                            <Pill icon={<ShieldAlert className="w-4 h-4" />} label="Ayıplı Mal" />
                            <Pill icon={<RefreshCcw className="w-4 h-4" />} label="İade Hakkı" />
                        </div>

                        {/* CTA’lar (Tüketici'ye uyarlandı) */}
                    ...
                    {/* Sağ kutu (Tüketici'ye uyarlandı) */}
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                <h3 className="font-semibold" style={{ color: NAVY }}>
                                    Tüketici Süreci Nasıl İşler?
                                </h3>
                                <p className="text-sm text-neutral-600 mt-1">
                                    Satıcıya ihtar, Tüketici Hakem Heyeti (THH) başvurusu ve Tüketici Mahkemesi süreçleri.
                                </p>

                                <ul className="mt-3 space-y-2 text-sm">
                                    <li className="flex items-start gap-2">
                                        <span className="mt-1.5 h-2 w-2 rounded-full bg-amber-500" />
                                        Satıcı/sağlayıcı ile görüşme
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="mt-1.5 h-2 w-2 rounded-full bg-amber-500" />
                                        Tüketici Hakem Heyeti (THH) başvurusu
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="mt-1.5 h-2 w-2 rounded-full bg-amber-500" />
                                        Tüketici Mahkemesi (gerekirse)
                                    </li>
                                </ul>
                                ...
                                <div className="mt-4 grid sm:grid-cols-2 gap-3">
                                    <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
                                        ...
                                        <p className="text-xs text-neutral-600 mt-1">
                                            Belirli bir limite kadar THH zorunludur, üzeri için mahkeme.
                                        </p>
                                    </div>
                                    <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
                                        <div className="flex items-center gap-2 font-medium">
                                        ...
                                        <p className="text-xs text-neutral-600 mt-1">Fatura, garanti belgesi ve satıcı yazışmalarını güvenle paylaşın.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section id="turler" className="mx-auto max-w-7xl px-4 pb-4">
                <h2 className="text-xl md:text-2xl font-bold text-center" style={{ color: NAVY }}>
                    Başlıca Tüketici Hizmetleri
                </h2>
                <p className="mt-2 text-center text-neutral-600">
                    Alıcılar, aboneler ve hizmet alanlar için hukuki destek ve başvuru süreçleri.
                </p>

                <div className="mt-6 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
                    <TypeCard
                        icon={<ShieldAlert className="w-6 h-6" />}
                        title="Ayıplı Mal ve Hizmetler"
                        text="Satın aldığınız ürün veya hizmetin kusurlu çıkması durumunda iade, değişim veya onarım haklarınız."
                    />
                    <TypeCard
                        icon={<Scale className="w-6 h-6" />}
                        title="Tüketici Hakem Heyeti (THH)"
                        text="Uyuşmazlık bedeline göre zorunlu olan THH başvurularının yapılması ve takibi."
                    />
                    <TypeCard
                        icon={<ShoppingCart className="w-6 h-6" />}
                        title="Mesafeli Satışlar (E-Ticaret)"
                        text="İnternet alışverişlerinde cayma hakkı, teslimat sorunları ve iade süreçlerinin yönetimi."
                    />
                    <TypeCard
                        icon={<Receipt className="w-6 h-6" />}
                        title="Abonelik ve Devre Tatil"
                        text="Haksız abonelik ücretleri, taahhüt cayma bedelleri ve devre tatil sözleşmelerinin iptali."
                    />
                </div>
            </section>
            ...
            {/* ----------------- POPÜLER TÜKETİCİ BAŞVURULARI ----------------- */}
            <section className="bg-neutral-50 py-12">
                <div className="mx-auto max-w-7xl px-4">
                    <div className="mb-8 text-center">
                        <h2 className="text-2xl md:text-3xl font-bold" style={{ color: NAVY }}>
                            Popüler Tüketici Başvuruları
                        </h2>
                        <p className="mt-2 text-neutral-600">
                            Öne çıkan başvuruları keşfedin ve tahmini masrafları hızlıca görüntüleyin.
                        </p>
                    </div>

                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                        {POPULAR.map((card, idx) => ( // POPULAR verisi artık Tüketici odaklı
                            <article
                                key={`${card.title}-${idx}`}
                            ...
                            >
                                ...
                                <div className="mt-4 flex items-center justify-between">
                                    ...
                                    >
                                        {/* THH başvuruları genelde ücretsizdir ancak avukatlık bedeli olabilir, bu yüzden düşük bir bedel gösteriliyor */}
                                        ₺{card.price}
                                    </span>
