...
export default function Vergi() {
    ...
    return (
        <div className="min-h-screen bg-white text-neutral-900">
            ...
            {/* ----------------- POPÜLER VERGİ BAŞVURULARI ----------------- */}
            <section className="bg-neutral-50 py-12">
                <div className="mx-auto max-w-7xl px-4">
                    <div className="mb-8 text-center">
                        <h2 className="text-2xl md:text-3xl font-bold" style={{ color: NAVY }}>
                            Popüler Vergi İlanları
                        </h2>
                        <p className="mt-2 text-neutral-600">
                            Öne çıkan ilanları keşfedin ve tahmini hizmet bedellerini görüntüleyin.
                        </p>
                    </div>

                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                        {POPULAR.map((card, idx) => ( // POPULAR verisi artık Vergi odaklı
                            <article
                                key={`${card.title}-${idx}`}
