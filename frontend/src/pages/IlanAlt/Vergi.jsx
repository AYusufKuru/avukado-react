...
import {
    ...
    Users,       // Taraflar
    // Vergi Hukuku için eklenen/kullanılan ikonlar
    Landmark,    // Vergi Dairesi, Kamu
    Calculator,  // Hesaplama, Danışmanlık
    FileWarning, // Uyuşmazlık, İhtarname
    Percent      // KDV, Oranlar
} from "lucide-react";
...
export default function Vergi() {
    ...
    // Vergi kategorisindeki ilanları API'den çek
        ...
        <div className="min-h-screen bg-white text-neutral-900">
                ...
                <div className="mx-auto max-w-7xl px-4 py-12 lg:py-14 grid gap-8 lg:grid-cols-[1.1fr_1fr] items-start">
                    ...
                    <div>
                        <h1 className="text-3xl md:text-4xl font-extrabold leading-tight" style={{ color: NAVY }}>
                            Vergi Hukuku: Uyum, <br className="hidden md:block" />
                            Danışmanlık ve Uyuşmazlıklar
                        </h1>

                        <p className="mt-4 text-neutral-700 max-w-2xl">
                            Vergi süreçlerinizin her aşamasında şeffaflıkla size eşlik ediyoruz.
                            VUK (Vergi Usul Kanunu), vergi incelemesi, uzlaşma süreçleri ve
                            durumunuza göre oluşabilecek maliyetleri burada özetliyoruz.
                        </p>

                        {/* Kısa bilgi butonları (Vergi'ye uyarlandı) */}
                        <div className="mt-5 flex flex-wrap gap-3">
                            <Pill icon={<Gavel className="w-4 h-4" />} label="Süreç" />
                            <Pill icon={<Calculator className="w-4 h-4" />} label="Vergi Uyum" />
                            <Pill icon={<FileWarning className="w-4 h-4" />} label="Uyuşmazlıklar" />
                            <Pill icon={<Percent className="w-4 h-4" />} label="KDV İadesi" />
                        </div>

                        {/* CTA’lar (Vergi'ye uyarlandı) */}
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                <h3 className="font-semibold" style={{ color: NAVY }}>
                                    Vergi Süreci Nasıl İşler?
                                </h3>
                                <p className="text-sm text-neutral-600 mt-1">
                                    Vergi incelemesi, uzlaşma komisyonu, vergi/ceza ihbarnamesi ve vergi mahkemesi süreçleri.
                                </p>

                                <ul className="mt-3 space-y-2 text-sm">
                                    <li className="flex items-start gap-2">
                                        <span className="mt-1.5 h-2 w-2 rounded-full bg-amber-500" />
                                        Vergi incelemesi ve raporlama
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="mt-1.5 h-2 w-2 rounded-full bg-amber-500" />
                                        Uzlaşma veya ceza ihbarnamesi
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="mt-1.5 h-2 w-2 rounded-full bg-amber-500" />
                                        Vergi Mahkemesi dava süreci
                                    </li>
                                </ul>
                                ...
                                <div className="mt-4 grid sm:grid-cols-2 gap-3">
                                    <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
                                        ...
                                        <p className="text-xs text-neutral-600 mt-1">
                                            İhbarname sonrası uzlaşma veya 30 gün içinde dava açma hakkı.
                                        </p>
                                    </div>
                                    <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
                                        <div className="flex items-center gap-2 font-medium">
                                        ...
                                        <p className="text-xs text-neutral-600 mt-1">İhbarname, defterler, faturalar ve raporları güvenle paylaşın.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section id="turler" className="mx-auto max-w-7xl px-4 pb-4">
                <h2 className="text-xl md:text-2xl font-bold text-center" style={{ color: NAVY }}>
                    Başlıca Vergi Hizmetleri
                </h2>
                <p className="mt-2 text-center text-neutral-600">
                    Mükellefler ve şirketler için vergi uyum, danışmanlık ve uyuşmazlık çözümleri.
                </p>

                <div className="mt-6 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
                    <TypeCard
                        icon={<Calculator className="w-6 h-6" />}
                        title="Vergi Danışmanlığı ve Uyum"
                        text="KDV, Gelir/Kurumlar Vergisi uyumu, beyanname desteği ve transfer fiyatlandırması."
                    />
                    <TypeCard
                        icon={<FileWarning className="w-6 h-6" />}
                        title="Vergi Uyuşmazlıkları ve Davaları"
                        text="Vergi/ceza ihbarnamelerinin iptali, haksız ödemelerin iadesi ve vergi mahkemesi süreçleri."
                    />
                    <TypeCard
                        icon={<Landmark className="w-6 h-6" />}
                        title="Vergi İncelemesi ve Uzlaşma"
                        text="Vergi inceleme süreçlerinde temsil, rapor değerlendirme ve uzlaşma komisyonu."
                    />
                    <TypeCard
                        icon={<Percent className="w-6 h-6" />}
                        title="Dolaylı Vergiler (KDV/ÖTV)"
                        text="KDV iade süreçleri (İhraç kayıtlı, indirimli oran), ÖTV istisnaları ve gümrük vergileri."
                    />
                </div>
            </section>
            ...
            {/* ----------------- VERGİ HUKUKU İLANLARI ----------------- */}
            <section className="bg-neutral-50 py-12">
                <div className="mx-auto max-w-7xl px-4">
                    <div className="mb-8 text-center">
                        <h2 className="text-2xl md:text-3xl font-bold" style={{ color: NAVY }}>
                            Vergi Hukuku İlanları
                        </h2>
                        <p className="mt-2 text-neutral-600">
                            Müvekkillerin oluşturduğu vergi hukuku ilanlarını keşfedin ve teklif verin.
                        </p>
                    </div>
                    ...
                    {isLoadingAds ? (
                        ...
                        <div className="text-center py-12">
                            <p className="text-neutral-600">Henüz vergi hukuku kategorisinde açık ilan bulunmamaktadır.</p>
                        </div>
                    ) : (
